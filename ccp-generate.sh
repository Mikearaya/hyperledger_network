...
P1PORT=10051
CAPORT=8054
PEERPEM=crypto-config/peerOrganizations/org2.bionic.com/tlsca/tlsca.org2.bionic.com-cert.pem
CAPEM=crypto-config/peerOrganizations/org2.bionic.com/ca/ca.org2.bionic.com-cert.pem
